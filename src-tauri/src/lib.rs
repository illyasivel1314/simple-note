...
use log::info;
use tauri::App;
use crate::rust::business::controller::{calendar_controller, note_controller};
use crate::rust::config::component::handler::InitialTaskManger;
use crate::rust::config::component::plugin::{tauri_plugin_log_init, tauri_plugin_single, tauri_plugin_tray};
